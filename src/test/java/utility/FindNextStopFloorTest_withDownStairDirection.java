...
public class FindNextStopFloorTest_withDownStairDirection {
    ...
    public FindNextStopFloorTest_withDownStairDirection(String discription, int[] from, int[] to, int expected) {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {"6. upper to same direction  ", new int[]{}, new int[]{2, -1}, -1},
                {"7. upstair over down stair ", new int[]{}, new int[]{-1, 3}, -1},
                {"8. upstair over down stair ", new int[]{}, new int[]{3, -1}, -1},


                {"9. from diffrent floor ", new int[]{2, 3}, new int[]{}, 2},
                {"10. from different floor ", new int[]{-2, -1}, new int[]{}, -1},
                {"11. from diffrent floor ", new int[]{2, -3}, new int[]{}, -3},
                {"12. from different floor ", new int[]{0, 2}, new int[]{}, 0},
                {"13. from different floor ", new int[]{2, 0}, new int[]{}, 0},

                {"14. from 1 ", new int[]{-2}, new int[]{}, -2},
                {"15. to 1 ", new int[]{}, new int[]{-2}, -2},
